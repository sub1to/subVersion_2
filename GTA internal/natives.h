...
namespace DLC1
{
	...
	static void GET_SHOP_PED_COMPONENT(Hash p0, Any* structure) { invoke<Void>(0x74C0E2A57EC66760, p0, structure); } // 0x74C0E2A57EC66760 0xB39677C5
