...
namespace UI
{
	...
	static void _SET_NOTIFICATION_COLOR_NEXT(int p0) { invoke<Void>(0x39BBF623FC803EAC, p0); } // 0x39BBF623FC803EAC 0x6F1A1901
...
namespace GRAPHICS
{
	...
	static void _END_TEXT_COMMAND_SCALEFORM_2() { invoke<Void>(0xAE4E8157D9ECF087); } // 0xAE4E8157D9ECF087 0x2E80DB52
...
namespace FIRE
{
	...
	static void ADD_EXPLOSION(float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isInvisible, float cameraShake, BOOL noDmg) { invoke<Void>(0xE3AD2BDBAEE269AC, x, y, z, explosionType, damageScale, isAudible, isInvisible, cameraShake, noDmg); } // 0xE3AD2BDBAEE269AC 0x10AF5258
...
namespace NETWORK
{
	...
	static ULONGLONG GET_NETWORK_TIME() { return invoke<int>(0x7A5487FE9FAA6B48); } // 0x7A5487FE9FAA6B48 0x998103C2
